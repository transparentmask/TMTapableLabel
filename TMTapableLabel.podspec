...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TMTapableLabel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Martin Yin/TMTapableLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Martin Yin' => 'transparentmask@gmail.com' }
  s.source           = { :git => 'https://github.com/Martin Yin/TMTapableLabel.git', :tag => s.version.to_s }
